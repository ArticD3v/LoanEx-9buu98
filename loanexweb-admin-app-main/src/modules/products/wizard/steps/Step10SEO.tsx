    ...
    <View style={styles.container}>
      ...
      {formData.metaTitle && (
        <Card style={styles.preview}>
          ...
          <Text style={styles.previewTitle} numberOfLines={1}>{formData.metaTitle}</Text>
          <Text style={styles.previewUrl}>yoursite.com/products/{formData.slug || 'product-slug'}</Text>
          <Text style={styles.previewDesc} numberOfLines={2}>
            {formData.metaDescription || formData.shortDescription || 'No description provided.'}
          </Text>
        </Card>
      )}
    </View>
