...
export const MEGA_MENU_CATEGORIES: CategoryItem[] = [
  {
    ...
    path: '/products',
    icon: 'pi pi-desktop',
    description: 'TVs, audio, and smart devices',
  },
  {
    id: 'mobiles',
    label: 'Mobiles',
    path: '/products',
    icon: 'pi pi-mobile',
    description: 'Latest smartphones & plans',
  },
  {
    id: 'laptops',
    label: 'Laptops',
  ...
  },
  {
    ...
    description: 'Apparel and lifestyle picks',
  },
  {
    id: 'appliances',
  ...
  },
  {
    ...
    path: '/products',
    icon: 'pi pi-sparkles',
    description: 'Add-ons that complete the look',
  },
];
